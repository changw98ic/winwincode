...
test('shared scalar values reject null, invalid versions, unsafe revisions, and malformed hashes', async () => {
  ...
  assertValid(schema, 'ObservationId', `sha256:${'c'.repeat(64)}`)
  assertInvalid(schema, 'ObservationId', 'observation-1')
  assertInvalid(schema, 'ObservationId', `sha256:${'C'.repeat(64)}`)
