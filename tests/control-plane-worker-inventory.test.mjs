...
const TARGET_SOURCE_ROOTS = Object.freeze([
  ...
  'crates/winwincode-connector-github/src',
  'crates/winwincode-connector-jira/src',
  'crates/winwincode-connector-linear/src',
  'crates/winwincode-connector-slack/src',
  'crates/winwincode-connector-teams/src',
  'crates/winwincode-connector-webhook/src',
  ...
  'crates/winwincode-observability-core/src',
  'crates/winwincode-observability-sqlite/src',
  ...
  'packages/browser-ui/src',
  'packages/control-plane-client/src',
  'crates/winwincode-client-port/src',
  'crates/winwincode-device-client/src',
])
