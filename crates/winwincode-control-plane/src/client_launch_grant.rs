...
mod tests {
    ...
    fn issuance_for(
        ...
        LaunchGrantIssuance::try_new(
            ...
            token,
            binding,
            format!("wsn_{}", suffix(seed + 8)),
            format!("wrk_{}", suffix(seed + 9)),
            format!("wki_{}", suffix(seed + 10)),
            DIGEST,
    ...
    fn representative_store_errors_map_one_to_one_onto_the_service_taxonomy() {
        ...
        let invalid = LaunchGrantIssuance::try_new(
            ...
            format!("wsn_{}", suffix(6)),
            format!("wrk_{}", suffix(7)),
            format!("wki_{}", suffix(8)),
            DIGEST,
            None,
            None,
            instant("2026-01-01T01:00:00.000Z"),
        ...
        let issuance = LaunchGrantIssuance::try_new(
            ...
            format!("wsn_{}", suffix(26)),
            format!("wrk_{}", suffix(27)),
            format!("wki_{}", suffix(28)),
            DIGEST,
            None,
            None,
            instant("2026-01-01T01:00:00.000Z"),
        ...
        let settlement = LaunchAckSettlement::try_new(
            ...
            1,
            format!("wsn_{}", suffix(32)),
            format!("wrk_{}", suffix(33)),
            format!("wki_{}", suffix(34)),
            true,
            None,
        )
        .expect("settlement");
