 ...
 * by the upstream markdown fixtures.
 *
...
const css = {
  "fileMention": "wwc-dsh-markdowntext-fileMention",
  "image": "wwc-dsh-markdowntext-image",
  "imageAlt": "wwc-dsh-markdowntext-imageAlt",
  "markdown": "wwc-dsh-markdowntext-markdown",
  "tableScroll": "wwc-dsh-markdowntext-tableScroll"
} as const
 ...
 * @param nodes - Subtrees to walk (top-level blocks or nested children).
...
/** A list is loose when it or one of its items is spread; every item then keeps its paragraphs. */
...
function renderListItem(
  ...
  // (or a trailing child when loose).
