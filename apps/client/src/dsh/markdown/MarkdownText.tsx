...
/** One settled full render: parse GFM, resolve references, append the footnote section. */
 ...
 * `streaming` renders fences plain (highlighting lands on
 ...
 * @returns A GFM document; raw HTML,
