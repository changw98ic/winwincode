...
export function mountWinWinCodeClient(
  ...
  async function renderStrongFlow(generation: number): Promise<void> {
    ...
    try {
      ...
      const routeDeliveryId = parameters.get('delivery') as DeliveryId | null
