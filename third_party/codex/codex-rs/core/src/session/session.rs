...
pub(crate) struct SessionSettingsUpdate {
    ...
    pub(crate) submit_change_batch: Option<bool>,
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let services = SessionServices {
                ...
                model_client: {
                    ...
                    let client = match model_stream_transport {
                        Some(transport) => client.with_model_stream_transport(
                            config.model_provider_id.clone(),
                            transport,
                        ),
                        None => client,
                    };
                    client.with_prompt_cache_key_override(
